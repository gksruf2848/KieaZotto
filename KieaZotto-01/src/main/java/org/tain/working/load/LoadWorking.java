...
import org.tain.working.load.tables.TblWordLoader;
...
public class LoadWorking {
	...
	@Autowired
	private TblWordLoader tblWordLoader;
	
	private void loadTblWord() throws Exception {
		log.info("---> KANG-20210405 >>>>> {} {}", CurrentInfo.get());
		
		if (Boolean.TRUE) this.tblWordLoader.loading();
	}
}
